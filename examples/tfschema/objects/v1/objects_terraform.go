...
func GenSchemaObjects(ctx context.Context) (github_com_hashicorp_terraform_plugin_framework_resource_schema.Schema, github_com_hashicorp_terraform_plugin_framework_diag.Diagnostics) {
	return github_com_hashicorp_terraform_plugin_framework_resource_schema.Schema{Attributes: map[string]github_com_hashicorp_terraform_plugin_framework_resource_schema.Attribute{
		"bool_map": github_com_hashicorp_terraform_plugin_framework_resource_schema.MapAttribute{
			...
			Optional:      true,
			PlanModifiers: []github_com_hashicorp_terraform_plugin_framework_resource_schema_planmodifier.Map{github_com_hashicorp_terraform_plugin_framework_resource.UseStateForUnknown()},
		},
		...
		"branch_int": github_com_hashicorp_terraform_plugin_framework_resource_schema.Int64Attribute{
			...
			Description:   "",
			Optional:      true,
			PlanModifiers: []github_com_hashicorp_terraform_plugin_framework_resource_schema_planmodifier.Int64{github_com_hashicorp_terraform_plugin_framework_resource.UseStateForUnknown()},
		},
		...
		"branch_nested": github_com_hashicorp_terraform_plugin_framework_resource_schema.SingleNestedAttribute{
			Attributes: map[string]github_com_hashicorp_terraform_plugin_framework_resource_schema.Attribute{"leaf": github_com_hashicorp_terraform_plugin_framework_resource_schema.SingleNestedAttribute{
				...
				Description:   "",
				Optional:      true,
				PlanModifiers: []github_com_hashicorp_terraform_plugin_framework_resource_schema_planmodifier.Object{github_com_hashicorp_terraform_plugin_framework_resource.UseStateForUnknown()},
			}},
			Description: "",
			Optional:    true,
		},
		...
		"primitives": github_com_hashicorp_terraform_plugin_framework_resource_schema.SingleNestedAttribute{
			Attributes: map[string]github_com_hashicorp_terraform_plugin_framework_resource_schema.Attribute{
				...
				"double_value": github_com_hashicorp_terraform_plugin_framework_resource_schema.Float64Attribute{
					...
					Optional:      true,
					PlanModifiers: []github_com_hashicorp_terraform_plugin_framework_resource_schema_planmodifier.Float64{github_com_hashicorp_terraform_plugin_framework_resource.UseStateForUnknown()},
				},
...
// CopyObjectsToTerraform copies contents of source struct into a Terraform object.
func CopyObjectsToTerraform(ctx context.Context, obj *github_com_gravitational_protoc_gen_terraform_v4_examples_types.Objects, tf *github_com_hashicorp_terraform_plugin_framework_types.Object) (github_com_hashicorp_terraform_plugin_framework_types.Object, github_com_hashicorp_terraform_plugin_framework_diag.Diagnostics) {
...
func CopyObjectsToTerraformPreserveUnknown(ctx context.Context, obj *github_com_gravitational_protoc_gen_terraform_v4_examples_types.Objects, tf *github_com_hashicorp_terraform_plugin_framework_types.Object, preserveUnknown bool) (github_com_hashicorp_terraform_plugin_framework_types.Object, github_com_hashicorp_terraform_plugin_framework_diag.Diagnostics) {
	...
	{
		attrType, ok := attrType.AttributeTypes()["bool_map"]
		if !ok {
	...
	{
		attrType, ok := attrType.AttributeTypes()["branch_empty"]
		if !ok {
			...
			if !ok {
				...
				attrs["branch_empty"] = v
			}
		}
	}
	{
		var v github_com_hashicorp_terraform_plugin_framework_attr.Value
		existing := attrs["branch_int"]
		if preserveUnknown && existing != nil && existing.IsUnknown() {
	...
	{
		attrType, ok := attrType.AttributeTypes()["branch_leaf"]
		if !ok {
	...
	{
		attrType, ok := attrType.AttributeTypes()["branch_nested"]
		if !ok {
			...
			if !ok {
				...
				attrs["branch_nested"] = v
			}
		}
	}
	{
		var v github_com_hashicorp_terraform_plugin_framework_attr.Value
		existing := attrs["branch_string"]
		if preserveUnknown && existing != nil && existing.IsUnknown() {
			v = github_com_hashicorp_terraform_plugin_framework_types.StringUnknown()
		} else {
			{
		...
		attrs["branch_string"] = v
	}
	{
		var v github_com_hashicorp_terraform_plugin_framework_attr.Value
		existing := attrs["embedded_value"]
		if preserveUnknown && existing != nil && existing.IsUnknown() {
			v = github_com_hashicorp_terraform_plugin_framework_types.StringUnknown()
		} else {
			if obj.LeafEmbedded == nil {
		...
		attrs["embedded_value"] = v
	}
	{
		attrType, ok := attrType.AttributeTypes()["empty"]
		if !ok {
	...
	{
		attrType, ok := attrType.AttributeTypes()["int_map"]
		if !ok {
	...
	{
		attrType, ok := attrType.AttributeTypes()["nested_map"]
		if !ok {
	...
	{
		attrType, ok := attrType.AttributeTypes()["nested_value"]
		if !ok {
			...
			if !ok {
				...
				attrs["nested_value"] = v
			}
		}
	}
	{
		attrType, ok := attrType.AttributeTypes()["primitives"]
		if !ok {
	...
	{
		attrType, ok := attrType.AttributeTypes()["string_map"]
		if !ok {
