...
var _ provider.ResourceType = &primitivesResourceType{}
...
func (c primitivesResourceType) NewResource(_ context.Context, p provider.Provider) (resource.Resource, diag.Diagnostics) {
