...
type TerraformType struct {
	...
	// UnknownValueMethod is the method called to construct an unknown attr.Value
	UnknownValueMethod string
...
func (f *Field) setMapValues(c *FieldBuildContext) error {
	...
	f.UnknownValueMethod = f.MapValueField.UnknownValueMethod
